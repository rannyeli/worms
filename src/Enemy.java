...
//		}		
//	}
//	public boolean checkCounter()//a function that will be called every loop in the main thread
//	{
...
//	}
	...
	public void updatePath(){
		if(this.getPath()==null||this.getPath().getPathEdgeList()==null||this.getPath().getPathEdgeList().size()==0){
			System.out.println("this-i:"+this.getY()/42+" this-j: "+this.getX()/42);
			this.setPath(GraphFacilities.findShortestPathLength(GraphFacilities.vertexMat[this.getY()/42][this.getX()/42]));//dijkstra
